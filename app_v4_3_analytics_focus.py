...
with st.expander("Analytics Focus", expanded=False):
    if not analytics_habits:
        st.write("No habits available for analytics yet.")
    else:
        st.markdown('<div class="expander-note">Pick one habit and both sections below will update together.</div>', unsafe_allow_html=True)
