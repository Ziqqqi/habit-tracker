                ...
                with st.expander("Manage", expanded=False):
                    ...
                    with st.form(f"edit_form_{row['habit_id']}"):
                        ...
                        edit_cfg = get_frequency_form_config(
                            edit_frequency_type,
                            frequency_value=int(row["frequency_value"]) if row["frequency_value"] else 1,
                            target_count=int(row["target_count"]) if row["target_count"] else 1,
                        )
                        ...
                        if edit_cfg["show_frequency_input"]:
                            edit_frequency_value = st.number_input(
                                ...
                                min_value=1,
                                value=int(edit_cfg["frequency_value"]),
                                step=1,
                        ...
                        edit_target = st.number_input(
                            ...
                            min_value=1,
                            value=int(edit_cfg["target_value"]),
                            step=1,
